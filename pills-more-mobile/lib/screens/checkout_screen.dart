...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _placeOrder() async {
    ...
    final orderData = {
      ...
      'paymentMethod': _paymentMethod == 'COD' ? 'Cash on Delivery' : 'ONLINE',
      'paymentId': null,
                      ...
                      child: _isCreatingOrder
                          ...
                          : ElevatedButton(
                              onPressed: _currentStep == 1
                                  ...
                                  : _placeOrder,
                              child: Text(_currentStep == 1 ? 'CONTINUE TO PAYMENT' : 'PLACE ORDER (₹${cart.grandTotal.toStringAsFixed(2)})'),
                            ),
                    ),
                  ],
                ),
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? const Color(0xFF0F766E).withOpacity(0.04) : Colors.white,
                    border: Border.all(
